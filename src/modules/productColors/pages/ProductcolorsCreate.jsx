...
import { useProductcolorsCreate } from "../hooks/useProductcolorsCreate";
import ButtonLoader from "components/shared/ButtonLoader";
const ProductcolorsCreate = () => {
  const {
    handleCancel,
    hanldeCreate,
    register,
...
export default ProductcolorsCreate;
